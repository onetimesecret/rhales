...
class MockUIContext < Rhales::Context
  def initialize(req = nil, sess = nil, cust = nil, locale_override = nil, props: {})
    # Simulate building onetime_window data like UIContext does
    onetime_window = build_mock_onetime_window_data(req, sess, cust, locale_override)
  ...
  def build_mock_onetime_window_data(req, sess, cust, locale_override)
    {
      authenticated: true,
      custid: 'cust123',
