...
class App < Roda
  use Rack::Session::Cookie, secret: 'demo_secret_key_change_in_production', key: '_rhales_demo_session'
  ...
  def rhales_render(template_name, locals = {})
    ...
    session_adapter = RodaSessionAdapter.new(session)
    ...
    view.render(template_name, runtime_data, business_data)
  end
